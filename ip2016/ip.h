...
Image*	ip_image_shift (Image* src);
...
Image*	ip_rotate (Image* src, double theta, int x, int y, int mode, int size, double sigma);
Image*	ip_saturate (Image* src, double alpha);
Image*	ip_scale (Image* src, double x, double y, int mode, int size, double sigma);
